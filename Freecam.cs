...
namespace Terkoiz.Freecam
{
    public class Freecam : MonoBehaviour
    {
        ...
        public void Update()
        {
            ...
            {
                if (Input.GetKey(KeyCode.Q)) transform.position += transform.up * (movementSpeed * Time.deltaTime);
                if (Input.GetKey(KeyCode.E)) transform.position += -transform.up * (movementSpeed * Time.deltaTime);
